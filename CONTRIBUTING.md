# Contributing to the Candy ecosystem 🥞

Thanks for taking the time to contribute !
You can start by reading our [Contribution guidelines](https://docs.candyswap.online/code/contributing) first.
...
```
TranslateString(675, `You have ${candyBalance} left in your wallet`, { num: candyBalance })
```
