...
import { getProfileContract, getCandyRabbitContract } from 'utils/contractHelpers'
...
const rabbitContract = getCandyRabbitContract()
  ...
  try {
    ...
    if (isActive) {
      ...
      Cookies.set(
        ...
        {
          username,
          avatar: `https://candyswap.online/images/nfts/${nft.images.sm}`,
        },
        { domain: 'candyswap.online', secure: true, expires: 30 },
      )
    }
