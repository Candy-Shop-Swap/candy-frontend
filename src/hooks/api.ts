 ...
 * @see https://github.com/Candy-Shop-Swap/gatsby-candy-api/commit/e811b67a43ccc41edd4a0fa1ee704b2f510aa0ba
 */
export const baseUrl = 'https://api.candyswap.com/api/v1'
