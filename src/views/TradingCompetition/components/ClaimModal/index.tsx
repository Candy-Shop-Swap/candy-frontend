...
import { Modal, Button, Flex, AutoRenewIcon, Heading, Text, Image } from '@candyswap-libs/uikit'
import useI18n from 'hooks/useI18n'
import { useTradingCompetitionContract } from 'hooks/useContract'
import { useToast } from 'state/hooks'
import { getBalanceNumber } from 'utils/formatBalance'
import { CompetitionProps } from '../../types'
import NftBunnies from '../../pngs/candies-nft.png'
...
const ClaimModal: React.FC<CompetitionProps> = ({ onDismiss, onClaimSuccess, userTradingInformation }) => {
  ...
  const { userRewardGroup, userCandyRewards, userPointReward, canClaimNFT } = userTradingInformation

  const candyAsBigNumber = new BigNumber(userCandyRewards as string)
  const candyToDisplay = getBalanceNumber(candyAsBigNumber).toFixed(2)
