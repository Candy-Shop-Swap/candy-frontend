...
import { LinkExternal, Text } from '@candyswap-libs/uikit'
...
const ActionPanel: React.FunctionComponent<ActionPanelProps> = ({ details, apr, multiplier, liquidity }) => {
  ...
  const info = `https://candyswap.info/pair/${lpAddress}`
  ...
  return (
    <Container>
      <InfoContainer>
        {isActive && (
          <StakeContainer>
            <StyledLinkExternal href={`https://exchange.candyswap.online/#/add/${liquidityUrlPathParts}`}>
