...
import { AutoRenewIcon, Button, Checkbox, Flex, InjectedModalProps, Text } from '@candyswap-libs/uikit'
...
const PauseProfilePage: React.FC<PauseProfilePageProps> = ({ onDismiss }) => {
  ...
  const { numberCandyToReactivate } = useGetProfileCosts()
  const TranslateString = useI18n()
  const candyProfileContract = useProfileContract()
  ...
  return (
    <>
      ...
      <Text as="p" color="textSubtle" mb="24px">
        {TranslateString(999, `Cost to reactivate in future: ${getBalanceNumber(numberCandyToReactivate)} CANDY`)}
      </Text>
