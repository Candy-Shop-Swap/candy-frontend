...
import { Button, Flex, Heading, useModal, Won } from '@candyswap-libs/uikit'
import { useProfile } from 'state/hooks'
import useI18n from 'hooks/useI18n'
import ClaimNftAndCandyModal, { useCanClaim } from './ClaimGiftModal'
...
const ProfileHeader = () => {
  ...
  const [onPresentClaimGiftModal] = useModal(<ClaimNftAndCandyModal onSuccess={checkClaimStatus} />)
