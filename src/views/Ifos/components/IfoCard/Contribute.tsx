...
import { Box, Button, Flex, Text, useModal } from '@candyswap-libs/uikit'
...
const Contribute: React.FC<ContributeProps> = ({
  ...
  const handleContributeSuccess = (amount: BigNumber) => {
    toastSuccess('Success!', `You have contributed ${getBalanceNumber(amount)} CANDY-BNB LP tokens to this IFO!`)
