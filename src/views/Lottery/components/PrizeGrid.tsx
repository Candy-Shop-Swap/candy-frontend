...
import { Heading, Text } from '@candyswap-libs/uikit'
...
const PrizeGrid: React.FC<PrizeGridProps> = ({
  ...
  const candyBusdPrice = usePriceCandyBusd()

  const getCandyBusdValue = (amount: number) => {
    return new BigNumber(amount).multipliedBy(candyBusdPrice).toNumber()
  }
    ...
    <Grid pastDraw={pastDraw}>
      ...
      <GridItem>
        <RightAlignedHeading size="md">
          ...
          {!pastDraw && !candyBusdPrice.eq(0) && <CardBusdValue value={getCandyBusdValue(fourMatchesAmount)} />}
        </RightAlignedHeading>
      </GridItem>
      {/* 3 matches row */}
      <GridItem>
      ...
      <GridItem>
        <RightAlignedText>
          ...
          {!pastDraw && !candyBusdPrice.eq(0) && <CardBusdValue value={getCandyBusdValue(threeMatchesAmount)} />}
        </RightAlignedText>
      </GridItem>
      {/* 2 matches row */}
      <GridItem>
      ...
      <GridItem>
        <RightAlignedText>
          ...
          {!pastDraw && !candyBusdPrice.eq(0) && <CardBusdValue value={getCandyBusdValue(twoMatchesAmount)} />}
        </RightAlignedText>
      </GridItem>
      {/* Burn row */}
