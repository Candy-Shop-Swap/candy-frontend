...
import { Heading, CardBody, CardFooter, CandyRoundIcon, TicketRound } from '@candyswap-libs/uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading
              valueToDisplay={TranslateString(999, `${poolSize.toLocaleString()} CANDY`)}
              Icon={CandyRoundIcon}
            >
