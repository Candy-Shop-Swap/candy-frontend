...
import { Heading, Card, CardBody, CardFooter, Text, CandyRoundIcon, Flex, Skeleton } from '@candyswap-libs/uikit'
...
const TotalPrizesCard = () => {
  ...
  const lotteryPrizeAmountBusd = new BigNumber(lotteryPrizeAmount).multipliedBy(usePriceCandyBusd()).toNumber()
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} CANDY</Heading>
